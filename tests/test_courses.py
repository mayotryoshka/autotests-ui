...
def test_empty_courses_list(chromium_page_with_state: Page):
        ...
        empty_result_header = chromium_page_with_state.get_by_test_id('courses-list-empty-view-title-text')
        ...
        empty_result_text = chromium_page_with_state.get_by_test_id('courses-list-empty-view-description-text')
